...
function nathalie_mota_scripts() {
	...
	wp_enqueue_style('lightbox', get_template_directory_uri() . '/css/lightbox.css', false, '1.0', 'all');
	...
	wp_enqueue_script('theme-child-script', get_template_directory_uri() . '/js/theme.js', array(), '1.0.0', true);	wp_enqueue_script('theme-child-script');
